...
<html>
	...
	<div id="background-wrap">
		...
		<center>
			<tt>WRITE</tt>
			<br>
			<form action="Board_write_confirm.php" method="post" name="form">
				<table id="one" bgcolor="white" width="60%">
					<tr align="center">
						<td width="65%">
							<t1><b>제목</b></t1>
						</td>
					...
					<tr align="center">
						...
						<td>
							<input type="text" id="nick" value="<?= $nick ?>" name="nick" size=30% readonly>
						</td>
					</tr>
					<tr align="center">
